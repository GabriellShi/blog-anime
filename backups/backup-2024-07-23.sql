...
VALUES
  (
    12,
    'Kimetsu no Yaiba – 4º temporada ganha teaser do clímax e terá final 2 episódios de 1 hora',
    '',
    '',
    'O site oficial da adaptação em anime de Kimetsu no Yaiba liberou um novo teaser para promover o clímax final da temporada.',
    '',
    'Kimetsu no Yaiba',
    'Novidades',
    'https://bloggeek.b-cdn.net/2024/NOVIDADES/19-06/imagem%20nova.png',
    '',
    '2024-06-19 22:36:34',
    'Animes',
    '6NpVW_bprHg'
